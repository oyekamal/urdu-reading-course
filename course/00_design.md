...
| 14 | **Audio on every letter, word and sentence**, generated locally with an MMS-VITS Urdu voice (sharjeel103 fine-tune, chosen by a Whisper-judged bake-off over the Meta baseline, `research/06_tts_bakeoff.md`). | Delacy has no audio at all; Alif Baa's companion site is audio-first. Audio is the biggest gap in the book tradition. | `research/00_quality_bar.md`, `research/05_open_assets.md` |
