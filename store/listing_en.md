...
• Letters are taught in frequency order, so the first six letters already make real words.
...
ACCESSIBILITY
• Large text, wider letter spacing (dyslexia-friendly), audio-first mode, romanisation on or off.
• Child, adult and heritage-speaker tracks change the pace and the hints.
...
## Privacy policy URL
https://oyekamal.github.io/urdu-reading-course/docs/privacy.html

## Data safety
No data collected. No data shared. Data is stored on device only; the user may export it via the Android share sheet.
