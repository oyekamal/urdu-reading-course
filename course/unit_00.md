# Unit 0 — Before the letters  ·  حروف سے پہلے
...
2. **Letters join like cursive.** Most letters change shape depending on where they sit: alone, first, middle, last. Ten letters never join to the letter after them: **ا ے و ر د ں ڈ ڑ ز ژ ذ**. After one of these the word "restarts".
...
|---|---|---|---|---|
| َ | zabar (زبر) | short a (as in 'but') | above | بَس bas — enough |
| ِ | zer (زیر) | short i (as in 'bit') | below | دِل dil — heart |
| ُ | pesh (پیش) | short u (as in 'put') | above | گُل gul — flower |
| ْ | jazm (sukūn) (جزم) | no vowel after this letter | above | سَبْزی sabzī — vegetable |
| ّ | tashdīd (تشدید) | double the letter | above | بچّہ bachcha — child |
| ٰ | khaṛā zabar (کھڑا زبر) | long ā without alif | above | اعلیٰ aʻlā — high |

### Long vowels (written with letters)
| Letter | Sound | Example |
|---|---|---|
| ا | ā | کام kām |
| آ | ā (word start) | آم ām |
| ی | ī | تین tīn |
| و | ū | جوتا jūtā |
| و | o | روٹی roṭī |
| ے | e | لے le |
